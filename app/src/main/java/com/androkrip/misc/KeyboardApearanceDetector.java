...
/**
 * Modified class KeyboardApearanceDetector (original by Francesco Verheye)
 *
 * @version 1.0.0
 */
public class KeyboardApearanceDetector implements OnGlobalLayoutListener {
	...
	// Constructor
	public KeyboardApearanceDetector(Activity activity) {
