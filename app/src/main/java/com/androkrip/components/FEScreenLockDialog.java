...
/** 
 * Screen Lock Dialog for File Encryptor
 * 
 * @author Unicus (unicus<atmark>paranoiaworks.com) for Paranoia Works
 * @version 1.0.1
 */ 
public class FEScreenLockDialog extends ScreenLockDialog {
	
	public FEScreenLockDialog(View v, String decKeyHash, int decAlgCode) 
	{
		super(v, decKeyHash, decAlgCode);
	}	
	
	public FEScreenLockDialog(Activity context, String decKeyHash, int decAlgCode) 
	{
