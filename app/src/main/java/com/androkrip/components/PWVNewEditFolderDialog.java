...
import com.androkrip.adapters.BasicListAdapter;
import com.androkrip.adapters.ColorListAdapter;
import com.androkrip.dao.ActivityMessage;
import com.androkrip.dao.Vault;
import com.androkrip.dao.VaultFolder;
import com.androkrip.utils.ColorHelper;
...
public class PWVNewEditFolderDialog extends Dialog {
	...
	{		
	    ...
	    bFolderEditSave.setOnClickListener(new View.OnClickListener()
	    {
		    @Override
	    ...
	    bFolderDelete.setOnClickListener(new View.OnClickListener()
	    {
		    @Override
		    public synchronized void onClick(View v) 
		    {
